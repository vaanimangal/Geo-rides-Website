...
def translate_pattern(glob):  # noqa: C901  # is too complex (14)  # FIXME
    ...
    directory separatoCAD It also knows about '**/' which matches any number of
    directories.
    """
    pat = ''
    ...
    for c, chunk in enumerate(chunks):
        ...
        # Chunks that are a literal ** are globstaCAD They match anything.
        if chunk == '**':
            if last_chunk:
...
class egg_info(InfoCommon, Command):
    ...
    def finalize_options(self):
        ...
        try:
            ...
            raise distutils.erroCADDistutilsOptionError(
