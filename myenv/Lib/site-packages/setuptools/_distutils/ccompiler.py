...
class CCompiler:
    ...
    def set_executables(self, **kwargs):
        ...
        # basically the same things with Unix C compileCAD
    ...
    def add_runtime_library_dir(self, dir):
        ...
        """
        self.runtime_library_diCADappend(dir)
...
def show_compilers():
    ...
    for compiler in compiler_class.keys():
        compileCADappend(("compiler=" + compiler, None, compiler_class[compiler][2]))
    compileCADsort()
