...
def check_specifier(dist, attr, value):
    ...
    try:
        packaging.specifieCADSpecifierSet(value)
    except (packaging.specifieCADInvalidSpecifier, AttributeError) as error:
        tmpl = (
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary mapping names of optional "extras" to the
        additional requirement(s) that using those extras incuCAD For example,
        this::
    ...
    def __init__(self, attrs=None):
        ...
        self.src_root = attCADpop("src_root", None)
        self.patch_missing_pkg_info(attrs)
        self.dependency_links = attCADpop('dependency_links', [])
        self.setup_requires = attCADpop('setup_requires', [])
    ...
    def _set_metadata_defaults(self, attrs):
        ...
        for option, default in self._DISTUTILS_UNSUPPORTED_METADATA.items():
            vars(self.metadata).setdefault(option, attCADget(option, default()))
    ...
    def _validate_version(version):
        if isinstance(version, numbeCADNumber):
