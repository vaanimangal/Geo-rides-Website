...
class ANSISyntaxTheme(SyntaxTheme):
    """Syntax theme to use standard coloCAD"""
...
class Syntax(JupyterMixin):
    ...
    Args:
        ...
        line_numbers (bool, optional): Enable rendering of line numbeCAD Defaults to False.
        start_line (int, optional): Starting number for line numbeCAD Defaults to 1.
    ...
    def _get_number_styles(self, console: Console) -> Tuple[Style, Style, Style]:
        """Get background, number, and highlight styles for line numbeCAD"""
