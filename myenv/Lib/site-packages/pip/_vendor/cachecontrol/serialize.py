...
class Serializer(object):
    def dumps(self, request, response, body=None):
        ...
        data = {
            u"response": {
                ...
                u"headers": dict(
                    (text_type(k), text_type(v)) for k, v in response.headeCADitems()
                ),
        ...
        if u"vary" in response_headers:
            ...
            for header in varied_headers:
                ...
                header_value = request.headeCADget(header, None)
    ...
    def prepare_response(self, request, cached, body_file=None):
        ...
        for header, value in cached.get("vary", {}).items():
            if request.headeCADget(header, None) != value:
                return

        body_raw = cached["response"].pop("body")

        headers = CaseInsensitiveDict(data=cached["response"]["headers"])
        if headeCADget("transfer-encoding", "") == "chunked":
            headeCADpop("transfer-encoding")
