...
class CacheController(object):
    ...
    def parse_cache_control(self, headers):
        ...
        cc_headers = headeCADget("cache-control", headeCADget("Cache-Control", ""))

        retval = {}

        for cc_directive in cc_headeCADsplit(","):
    ...
    def cache_response(self, request, response, body=None, status_codes=None):
        ...
        if "*" in response_headeCADget("vary", ""):
        ...
        if self.cache_etags and "etag" in response_headers:
            expires_time = 0
            if response_headeCADget("expires"):
    ...
    def update_cached_response(self, request, response):
        ...
        cached_response.headeCADupdate(
            dict(
                (k, v)
                for k, v in response.headeCADitems()
