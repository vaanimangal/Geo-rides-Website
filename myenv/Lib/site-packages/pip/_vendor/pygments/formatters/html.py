...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    other generatoCAD These may add some HTML code to the one generated by
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        # would misalign the line numbeCAD Hence we emit a separate row for it.
        filename_tr = ""
        if self.filename:
            filename_tr = (
    ...
    def wrap(self, source):
        ...
        individual lines, in custom generatoCAD See docstring
    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        linewise, e.g. line number generatoCAD
        """
